        ...
        while(game_going == true){
            ...
            for(int i=0; i<9; i+=3){
                if(!board[i].equals("-") && !board[i+1].equals("-") && !board[i+2].equals("-")){
                    if(board[i].equals(board[i+1]) && board[i].equals(board[i+2]) && board[i+1].equals(board[i+2])){
                        game_going = false;
                    }
                }
            }
            ...
            for(int i=0; i<3; i++){
                if(!board[i].equals("-") && !board[i+3].equals("-") && !board[i+6].equals("-")){
                    if(board[i].equals(board[i+3]) && board[i].equals(board[i+6]) && board[i+3].equals(board[i+6])){
                        game_going = false;
                    }
                }
            }
            ...
            //check tie
            if(!board[0].equals("-") && !board[1].equals("-") && !board[2].equals("-") && !board[3].equals("-") && !board[4].equals("-") && !board[5].equals("-") && !board[6].equals("-") && !board[7].equals("-") && !board[8].equals("-")) {
                game_going = false;
            }
        }
